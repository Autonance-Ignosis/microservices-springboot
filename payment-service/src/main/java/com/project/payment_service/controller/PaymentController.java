...
public class PaymentController {
    ...
    @PostMapping("/deduct")
    public ResponseEntity<String> deduct(@RequestBody DeductRequest request) {
        paymentService.deductEmi(request);
        return ResponseEntity.ok("EMI Deducted Successfully");
    }
